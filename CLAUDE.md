...
- **Polish éventuel restant** : indicateur « en cours d'encodage » sur les cartes fraîchement uploadées, téléchargement « natif iOS » (sans rester dans l'app), couverture Playwright élève plus profonde (eleveData mocké).
