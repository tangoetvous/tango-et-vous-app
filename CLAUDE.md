...
- [ ] **Activer sauvegardes Supabase** : nécessite le plan Pro (25$/mois) — non disponible sur plan gratuit. Backup CSV nocturne via GitHub Actions `backup-csv.yml` utilisé à la place.
