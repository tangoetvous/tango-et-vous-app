...
- [ ] **Message au support AssoConnect — désactiver le pourboire par défaut** (2026-07-13) : demander s'il est possible de mettre le pourboire/contribution AssoConnect à **0 € par défaut** (ou de le masquer) sur le formulaire de collecte des cours de tango. Le plus radical pour régler le problème à la source. Texte de message rédigé (voir échange 2026-07-13) — à envoyer par l'admin.
