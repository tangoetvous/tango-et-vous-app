...
| **E-J1a** | Cron lendemain essai · élève présent (`presence_confirmee=true` ou marqué présent admin) | `confirme` | Élève | Bandeau vert ✓ · référence explicite au cours effectué la veille (ville, niveau, date, horaire depuis params) · process inscription (demande → validation → paiement CB 1x/3x, chèque, espèces) · encadré parité pour les solos · "les cours continuent dès la semaine prochaine" · bouton "Demande d'inscription →" (AssoConnect) · **pas de lien vers un autre cours d'essai** (une personne ne peut faire l'essai qu'une fois) |
| **E-J1b** | Cron lendemain essai · élève `confirme` non présent non annulé | `confirme` | Élève | Bandeau orange 💙 "Vous nous avez manqué" · référence au cours manqué (ville, niveau, date) · bouton "↩ Choisir une nouvelle date" (formulaire cours d'essai — car pas encore venu, l'essai n'a pas eu lieu) · note pas de pénalité |
