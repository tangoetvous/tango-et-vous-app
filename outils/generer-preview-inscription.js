...
const CAS = [
  ...
  { id: 'i01coupleatt', titre: "I01-att — Duo en liste d'attente", handler: 'handleNotifyInscriptionCours',
    note: "Quand le quota est atteint sur l'un des deux rôles, les DEUX partenaires passent en attente et reçoivent la version « liste d'attente » — ils seront confirmés ensemble.",
    body: { ...base, role: 'guidee', venue: 'avec-part', nbCours: 1, c1: { ville: 'paris', niveau: 'debutant' },
